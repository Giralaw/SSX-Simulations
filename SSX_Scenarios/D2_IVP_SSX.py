...
field_writes = solver.evaluator.add_file_handler('D2Data/fields_two', max_writes = 500, sim_dt = output_cadence, mode = fh_mode)
...
parameter_writes = solver.evaluator.add_file_handler('D2Data/parameters_two', max_writes = 1, sim_dt = 10*output_cadence, mode = fh_mode)
...
load_writes = solver.evaluator.add_file_handler('D2Data/load_data_two', max_writes = 500, sim_dt = output_cadence, mode = fh_mode)
